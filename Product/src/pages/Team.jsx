...
export default function Team() {
  const teamMembers = [
    { name: "Marini", role: "Anggota", img: Img2 },
    { name: "Herlita", role: "Ketua Anggota", img: Img1 },
    { name: "Rahma", role: "Anggota", img: Img3 },
  ];
      ...
      <div className="pt-22 pb-24 max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-center mt-5">
          ...
          >
            ...
            <h3 className="mt-6 text-xl font-bold text-gray-800">Dosen Pengampu</h3>
